...
/**
 * Class InformationConnection is used from the server to notify about a connection information.
 */
public class InformationConnection implements AnswerWithString{
    private final String string;

    /**
     * Constructor InformationConnection creates a new message with the given string.
