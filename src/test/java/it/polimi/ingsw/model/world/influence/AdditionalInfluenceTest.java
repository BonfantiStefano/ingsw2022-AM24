...
/**
 * Class AdditionalInfluenceTest tests AdditionalInfluence class.
 *
 * @author Bonfanti Stefano
 * @see AdditionalInfluence
 */
class AdditionalInfluenceTest {

    /** Method getInfluence tests the calculation of the influence with the strategy AdditionalInfluence.*/
    @Test
    @DisplayName("AdditionalInfluence's getInfluence method test")
    void getInfluence() {
        InfluenceStrategy additionalInfluence = new AdditionalInfluence();
